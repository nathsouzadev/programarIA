...
import { adaBotDetails } from '@/src/app/routes';
...
const CodePage = () => {
  ...
  return (
    <div>
      <Heading
        title={adaBotDetails.label}
        description={adaBotDetails.description}
        icon={adaBotDetails.icon}
        iconColor={adaBotDetails.color}
        bgColor={adaBotDetails.bgColor}
      />
      <div className='px-4 lg:px-8'>
                  ...
                  <FormItem className='col-span-12 lg:col-span-10'>
                    <FormControl className='m-0 p-0'>
                      <Input
                        ...
                        disabled={isLoading}
                        placeholder={adaBotDetails.placeholder}
                        {...field}
                      />
                    </FormControl>
                  </FormItem>
        ...
        <div className='space-y-4 mt-4'>
          ...
          {messages.length === 0 && !isLoading && (
            <Empty icon={MessageCircle} label={adaBotDetails.empty} />
          )}
